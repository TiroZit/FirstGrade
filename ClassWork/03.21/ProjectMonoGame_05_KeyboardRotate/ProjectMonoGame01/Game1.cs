...
namespace ProjectMonoGame01
{
    ...
    public class Game1 : Game
    {
        ...
        protected KeyboardControllerRotate KeyboardControllerRotate;
        protected MouseConroller mouseConroller;
        protected MouseConrollerSpectate mouseConrollerSpectate;
        ...
        protected override void Initialize()
        {
            ...
            KeyboardControllerRotate = new KeyboardControllerRotate();
            KeyboardControllerRotate.Attach(spaceship2);

            mouseConroller = new MouseConroller();
            mouseConroller.Attach(cursor);

            mouseConrollerSpectate = new MouseConrollerSpectate();
            mouseConrollerSpectate.Attach(spaceship);
        }
        ...
        {
            KeyboardControllerRotate.Update();
            mouseConroller.Update();
            mouseConrollerSpectate.Update();
